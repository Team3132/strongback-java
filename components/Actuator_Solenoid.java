...
public interface Actuator_Solenoid extends Actuator {
	...
	public default boolean isExtended() {
		return !this.isMoving() && (this.getCurrentPosition() == this.getTargetPosition()) && (this.getTargetPosition() == 1.0);
	}
	
	public default boolean isRetracted() {
		return !this.isMoving() && (this.getCurrentPosition() == this.getTargetPosition()) && (this.getTargetPosition() == 0.0);
	}
