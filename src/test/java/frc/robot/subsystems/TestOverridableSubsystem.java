...
public class TestOverridableSubsystem {
    ...
    public void testNormalMode() {
        ...
        real.setMotorOutput(0);
        simulator.setMotorOutput(0);
        mock.setMotorOutput(0);
        ...
        normalIntake.setMotorOutput(1);
        // Check that only the real interface got told about it.
        assertThat(real.getMotorOutput(), is(closeTo(1.0, 0.1)));
        assertThat(simulator.getMotorOutput(), is(closeTo(0, 0.1)));
        assertThat(mock.getMotorOutput(), is(closeTo(0, 0.1)));
        // Pretend to be the diag box and send through a command.
        overrideIntake.setMotorOutput(-1);
        // Check that only the real interface got told about it.
        assertThat(real.getMotorOutput(), is(closeTo(1.0, 0.1)));
        assertThat(simulator.getMotorOutput(), is(closeTo(0, 0.1)));
        assertThat(mock.getMotorOutput(), is(closeTo(-1, 0.1)));
        ...
        // Pretend to be the controller and send through a command.
        normalIntake.setMotorOutput(0.5);
        // Check that only the simulator got told about it.
        assertThat(real.getMotorOutput(), is(closeTo(1.0, 0.1)));
        assertThat(simulator.getMotorOutput(), is(closeTo(0.5, 0.1)));
        assertThat(mock.getMotorOutput(), is(closeTo(-1, 0.1)));
        // Pretend to be the diag box and send through a command.
        overrideIntake.setMotorOutput(-0.5);
        // Check that only the real interface got told about it.
        assertThat(real.getMotorOutput(), is(closeTo(-0.5, 0.1)));
        assertThat(simulator.getMotorOutput(), is(closeTo(0.5, 0.1)));
        assertThat(mock.getMotorOutput(), is(closeTo(-1, 0.1)));
        ...
        // Pretend to be the controller and send through a command.
        normalIntake.setMotorOutput(0.25);
        // Check that only the simulator got told about it.
        assertThat(real.getMotorOutput(), is(closeTo(-0.5, 0.1)));
        assertThat(simulator.getMotorOutput(), is(closeTo(0.25, 0.1)));
        assertThat(mock.getMotorOutput(), is(closeTo(-1, 0.1)));
        // Pretend to be the diag box and send through a command.
        overrideIntake.setMotorOutput(-0.25);
        // Check that only the mock got told about it.
        assertThat(real.getMotorOutput(), is(closeTo(-0.5, 0.1)));
        assertThat(simulator.getMotorOutput(), is(closeTo(0.25, 0.1)));
        assertThat(mock.getMotorOutput(), is(closeTo(-0.25, 0.1)));
    }
