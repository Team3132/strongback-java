...
public class Mock {
    ...
    public static final class Servos {
    	public static MockServo servo(int channel) {
    		return new MockServo();
    	}
    	public static MockTimedServo timedServo(int channel, double min, double max, double travelPerSecond, double initial) {
    ...
    public static final class AngleSensors {
    	...
    	public static MockAngleSensor potentiometer(int channel, double fullVoltageRangeToDegrees, double offsetInDegrees) {
    		return new MockAngleSensor();
    	}
    }
    ...
    public static final class Switches {
        ...
        public static MockSwitch normallyClosed(int channel) {
            MockSwitch input = new MockSwitchImplementation();
            return () -> { return !input.isTriggered(); };
        }
    ...
    public static final class Solenoids {
        /**
         * Create a mock double-acting solenoid that uses the specified channels on the default module.
         *
        ...
        /**
         * Create a mock double-acting solenoid that uses the specified channels on the given module.
         *
         ...
         * @return a solenoid on the specified channels; never null
         */
        public static MockSolenoid doubleSolenoid(int extendChannel, int retractChannel, double timeIn, double timeOut) {
         ...
         * @return a solenoid on the specified channels; never null
         */
        public static MockSolenoid doubleSolenoid(int module, int extendChannel, int retractChannel, double timeIn, double timeOut) {
            return new MockDoubleSolenoid(timeIn, timeOut);
        }
        
        /**
         * Create a mock single-acting solenoid that uses the specified channel on the default module.
         *
         * @param extendChannel the channel that extends the solenoid
         * @return a solenoid on the specified channels; never null
         */
         ...
         * @return a solenoid on the specified channels; never null
         */
        public static MockSolenoid singleSolenoid(int extendChannel, double timeIn, double timeOut) {
         ...
         * @return a solenoid on the specified channels; never null
         */
        public static MockSolenoid singleSolenoid(int module, int extendChannel, double timeIn, double timeOut) {
            return new MockSingleSolenoid(timeIn, timeOut);
        }
