 ...
 * will start the compressor, and {@link MockSwitchImplementation#setNotTriggered() un-triggering} the {@link #lowPressureSwitch() low
...
public class MockPneumaticsModule implements PneumaticsModule {
    ...
    private final MockSwitchImplementation running = new MockSwitchImplementation().setNotTriggered();
    ...
    protected static class StickyFaults implements Faults {
        private final MockSwitchImplementation currentTooHigh = new MockSwitchImplementation().setNotTriggered();
        private final MockSwitchImplementation notConnected = new MockSwitchImplementation().setNotTriggered();
        private final MockSwitchImplementation shorted = new MockSwitchImplementation().setNotTriggered();
