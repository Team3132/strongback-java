...
/**
	...
	public DriveMotion arcadeToTank(double moveValue, double turnValue, double scale, boolean squaredInputs) {
		return arcadeToTank(moveValue, turnValue, scale, squaredInputs, DriveSide.BOTH);
	}
	
	public DriveMotion arcadeToTank(double moveValue, double turnValue, double scale, boolean squaredInputs, DriveSide driveSide) {
//		double im = moveValue;
//		double it = turnValue;
