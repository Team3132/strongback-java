...
public class MovementSimulator {
	...
	public MovementSimulator(String name, double maxSpeed, double maxAccel, double minPos, double maxPos, double tolerance) {
		assert(maxAccel >= 0);
		assert(maxSpeed >= 0);
	 ...
	 * @return new speed
	 */
	public static double calculateSpeed(double dt, double currSpeed, double idealSpeed, double maxAccel) {
