 ...
 *  3) If something stops reading the serial port (like this script), then the video frames stop (ugh).
 */
...
public class Jevois implements JevoisInterface {
     ...
     *   D3 0.0041708097717292 -0.08790574004652713 0.6225565372368229 0.28 0.175 1.0 0.9757402399136117 -0.1237847793771889 0.17325008881164186 0.050918752288585487 FIRST
     *   D3 0.2703311590479972 0.34137431252665157 1.340374448197372 0.28 0.175 1.0 0.9416448768770811 -0.07495457893269117 0.32795451275561716 -0.011514100546526834 FIRST
     *   D3 -0.34479472541636735 0.34221938559564063 1.4353810619853402 0.28 0.175 1.0 0.9835028223168648 -0.1689770348306745 0.06316048382443286 0.013405725555073253 FIRST
     ...
     * 
     *   D3 <x pos, left is -ve> <y pos, up is -ve> <dist (meters)> <target width> <target height> <1.0>
