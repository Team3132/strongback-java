...
public class Sequences {
	...
	public static Sequence toggleDriveClimbModes() {
		SequenceBuilder builder = new SequenceBuilder("Toggle drive / climb modes");
		builder.add().toggleDriveClimbMode();
		return builder.build();
	}
	...
	public static Sequence toggleBuddyClimb() {
		SequenceBuilder builder = new SequenceBuilder("Toggle buddy climb attachment");
		builder.add().toggleBuddyClimb();
		return builder.build();
	}
