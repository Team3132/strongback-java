 ...
 *    onTriggered(buttonBoxJoystick.getButton(ButtonBoxMap.LIFT_ADD_HEIGHT), () -> overrideLift.liftHeightByDelta(2));
 *    onTriggered(buttonBoxJoystick.getButton(ButtonBoxMap.LIFT_DECREASE_HEIGHT), () -> overrideLift.liftHeightByDelta(-2));
 *    onTriggered(buttonBoxJoystick.getButton(ButtonBoxMap.SHIFTER_BUTTON), () -> overrideLift.setGear(overridableLift.isInHighGear()));
 * 
 ...
 */
public class OverridableSubsystem<SubIF> {
