 ...
 * Each subsystem needs to have a method that can be called to update the smart dashboard with important information.
 * 
 * This should NOT be the same as the information that is logged. The information that is passed to the smart dashboard
